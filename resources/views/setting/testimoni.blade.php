            ...
            <tr class="border-bottom">
                ...
                <td>
                    <div class="p-2 icons">
                        ...
                        <a onclick="return confirm('Are you sure ?')" class="border-0 bg-transparent" href="/tampilan/testimonidelete/{{ $our->id }}" title="delete user" >
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add Testimoni</h5>
      ...
      <div class="modal-body">
        ...
        <div class="row">
        <div class="col-md-12">
            <h2 class="mb-5 fs-3">Tambah Testimoni</h2>
    @if (session()->has('success'))
    <div class="alert alert-primary" role="alert">
{{ session('success') }}
    </div>
    ...
    @endif
                <form action="/tampilan/testimonisave" method="post" enctype="multipart/form-data">
                    @csrf
...
{{ session('success') }}
    ...
    @endif
                <form action="/tampilan/testimoniedit" method="post" enctype="multipart/form-data">
                    @csrf
        <div class="form-group row">
        <label for="namaMakanan" class="col-sm-3 col-form-label ">Nama </label>
