            ...
            <table>
                ...
                <tbody>
                    ...
                    @foreach ($menu as $trans )
                        ...
                        <td class="price">{{ number_format($trans->menu->harga * $trans->jumlah ) }}</td>
                    </tr>
                    @endforeach
...
?>
                    ...
                    <tr>
                        ...
                        <td class="description"><strong>PPN</strong></td>
                        <td class="price">{{ number_format($cor) }}</td>
                    </tr>
                    <tr>
                        <td class="quantity"></td>
                        <td class="description">TOTAL</td>
                        <td class="price">{{ number_format($total[0]->tb + $cor) }}</td>
                    </tr>
                </tbody>
            </table>
